import 'package:bengservices/src/enums/auth_mode.dart';
import 'package:bengservices/src/models/user_info_model.dart';
import 'package:bengservices/src/models/user_model.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http
          .get("https://bengservices-7e507.firebaseio.com/users.json");
  ...
  Future<bool> addUserInfo(Map<String, dynamic> userInfo) async {
    ...
    try {
      final http.Response response = await http.post(
          "https://bengservices-7e507.firebaseio.com/users.json",
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB5pCPQa45bmyY7OlkpDwV2ay0O7_H3jpE",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      } else if (authMode == AuthMode.SignIn) {
        response = await http.post(
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB5pCPQa45bmyY7OlkpDwV2ay0O7_H3jpE",
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
